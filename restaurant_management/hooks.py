...
doc_events = {
    "POS Profile": {
        "on_create": "restaurant_management.restaurant_management.page.RM.RM.set_pos_profile",
        "on_update": "restaurant_management.restaurant_management.page.RM.RM.set_pos_profile"
    },
}
